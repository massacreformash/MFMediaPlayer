...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        self.opacity = 0.8f;
		self.color = nil;
		self.labelFont = [UIFont boldSystemFontOfSize:kAdapedWidth(kLabelFontSize)];
		self.labelColor = [UIColor whiteColor];
		self.detailsLabelFont = [UIFont boldSystemFontOfSize:kAdapedWidth(kDetailsLabelFontSize)];
        ...
        [self p_showOrHideLoadingInfoDetail];
		[self setupLabels];
...
- (void)p_showOrHideLoadingInfoDetail {
    ...
    if ([loadingInfoDetail isEqualToString:@"1"]) {
        ...
        for (NSString *function in functionsArray) {
            BOOL isCaller = !([function containsString:@"CustomToast showWating"] || [function containsString:@"MBProgressHUD"]) && ([function containsString:@"["] && [function containsString:@"]"]);
            if (isCaller) {
        ...
        //        HQLog(@"%@",functionsArray);
        //        HQLog(@"function:%@",functionName);
        self.detailsLabelText = functionName;
    } else {
