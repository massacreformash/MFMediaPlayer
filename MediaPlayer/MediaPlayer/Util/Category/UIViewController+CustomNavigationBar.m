...
- (void)pc_configCustomNavigationBar {
    ...
    self.navigationBar.frame = CGRectMake(0, 0, HQScreenW, NAVBAR_HEIGHT);
    self.navigationBar.backgroundColor = kColorC4_3;
...
- (void)pc_configCustomNavRightButtonWithNavRightButtonIcon:(NSString *)NavRightButtonIcon
    ...
    if (NavRightButtonIcon || navRightButtonTitle) {
        ...
        [self.navRightButton setTitleColor:kColorC3_2 forState:UIControlStateNormal];
...
- (void)addBarMiddleButtonWithTitle:(NSString *)title {
    ...
    [self.navMiddleButton setTitleColor:kColorC3_1 forState:UIControlStateNormal];
